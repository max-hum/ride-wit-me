...
- Replace raw GPS coordinate inputs in the UI with an address or place search flow.
  Notes: prioritize city/street lookup first, remember the latest used location as the default, and treat map click selection as a phase-2 bonus.
